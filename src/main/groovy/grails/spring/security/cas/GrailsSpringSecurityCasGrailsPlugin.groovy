 ...
 */
package grails.spring.security.cas
...
class GrailsSpringSecurityCasGrailsPlugin extends Plugin {
    ...
    def issueManagement = [url: 'https://github.com/grails-plugins/grails-spring-security-cas']
